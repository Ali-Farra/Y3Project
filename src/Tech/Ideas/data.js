import idea1 from '../../Assist/mustang.jpg'
import idea2 from '../../Assist/iphone.jpg'
import idea3 from '../../Assist/pc.jpg'
import idea4 from '../../Assist/typec.jpg'
...

{
    img: idea4,
    alt: 'Accessories',
    name: 'Lightning to Type C adapter',
    about: 'Apple Iphones are using Lightning ports as the charging ports till today, but Type C ports are more modern , safer and faser that even apple uses them with IPads & MacBooks! But Apple sees it is too late now to add it.',
    notice: 'So, what if they invent an adapter to swich between them?!',
},
]